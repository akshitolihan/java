...
// static String[] empHead = { "EmpNo", "EmpName", "JoinDate", "Designation
// Code", "Department", "Basic", "HRA",
// "IT" };
...
// int[] basic = new int[empDetail.length];
// for (int i = 0; i < empDetail.length; i++) {
// basic[i] = Integer.parseInt(empDetail[i][5]);
// }
// for (int i = 0; i < basic.length; i++) {
// System.out.println(basic[i]);
// }

// int[] hra = new int[empDetail.length];
// for (int i = 0; i < empDetail.length; i++) {
// hra[i] = Integer.parseInt(empDetail[i][5]);
// }
// for (int i = 0; i < hra.length; i++) {
// System.out.println(hra[i]);
// }
// int[] it = new int[empDetail.length];
// for (int i = 0; i < empDetail.length; i++) {
// it[i] = Integer.parseInt(empDetail[i][5]);
// }
// for (int i = 0; i < it.length; i++) {
// System.out.println(it[i]);
// }
// int[] da = new int[empDetail.length];
// for (int i = 0; i < empDetail.length; i++) {
// da[i] = Integer.parseInt(empDetail[i][5]);
// }
...
// if (empHead[i] == "EmpNo" || empHead[i] == "EmpName" || empHead[i] ==
// "Department") {
