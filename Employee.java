...
public class Employee {
    ...
    public Employee(String empId, String depName, String empDesignation, String empName, String dateJoin, int basic,
            int hra, int it, char designationCode) {
        this.empId = empId;
    ...
    public static void details(String empId, String empName, String depName, String empDesignation, int salary) {
        ...
        System.out
                .println(empId + "\t\t" + empName + "\t\t" + depName + "\t\t\t" + empDesignation + "\t\t" + salary);
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        employees[0] = new Employee("1001", "R&D", "Engineer", "Ashish", "1/04/2009", 20000, 8000, 3000,
                'e');
        employees[1] = new Employee("1002", "PM", "Consultant", "Anjali", "23/08/2012", 30000, 12000, 9000, 'c');
        employees[2] = new Employee("1003", "Acct", "Clerk", "Raju", "12/11/2008", 10000, 8000, 1000,
                'k');
